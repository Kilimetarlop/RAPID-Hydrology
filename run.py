import argparse
import torch
from exp.exp_rapid_hydrology import Exp_RAPIDHydrology
import random
import numpy as np
import os
...
parser = argparse.ArgumentParser(description="RAPID-Hydrology")
...
parser.add_argument(
    "--model_id", type=str, required=True, default="RAPID-Hydrology", help="model id"
)
parser.add_argument(
    "--model", type=str, required=True, default="RAPID-Hydrology", help="model name"
)
parser.add_argument(
...
Exp_map = {
    "RAPID-Hydrology": Exp_RAPIDHydrology,
}
