...
class TokenEmbedding_RAPIDHydrology(nn.Module):
    def __init__(self, in_channels, d_model):
        super(TokenEmbedding_RAPIDHydrology, self).__init__()
...
class PositionalEncoding(nn.Module):
    def __init__(
        ...
        self.d_model = d_model
        self.position_encoding = RotaryPositionEncoding(d_model=d_model)
